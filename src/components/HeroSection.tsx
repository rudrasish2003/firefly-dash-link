...
const useCases = {
  "hr-recruitment": {
    ...
    human: {
      ...
      age: "28",
      gender: "F",
      expertise: "Basic HR Coordination",
      skills: [
        "Struggles to manage multiple candidates efficiently",
        "Often misses follow-ups during recruitment",
      ],
    },
  },
  "insurance-sales": {
    ...
    human: {
      ...
      age: "35",
      gender: "M",
      expertise: "Limited Insurance Knowledge",
      skills: [
        "Finds it hard to explain policies clearly",
        "Can't save money personally, poor at financial discipline",
      ],
    },
  },
  "insurance-claims": {
    ...
    human: {
      ...
      age: "32",
      gender: "F",
      expertise: "Basic Claims Handling",
      skills: [
        "Easily confused by complex documentation",
        "Slow to provide claim updates to clients",
      ],
    },
  },
  "bank-support": {
    ...
    human: {
      ...
      age: "29",
      gender: "M",
      expertise: "Basic Customer Assistance",
      skills: [
        "Has a bad credit score and limited financial discipline",
        "Takes long to resolve simple account issues",
      ],
    },
  },
  "real-estate": {
    ...
    aiAvatar:
      "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRyOfNxyO1J_vEJOu7qAv2LiQRdF-rXaaUHYqrvidjnuQIyZxWA",
    humanAvatar:
      "https://t3.ftcdn.net/jpg/13/41/89/02/360_F_1341890295_Ed4pQXKuJmzZOLMk5EDCb5jjsuCEewCQ.jpg",
    robot: {
      name: "RealtorBot",
      age: "AI Assistant",
    ...
    human: {
      ...
      age: "31",
      gender: "F",
      expertise: "Limited Real Estate Knowledge",
      skills: [
        "Often forgets property details during discussions",
        "Struggles with negotiating good deals for clients",
      ],
    },
  },
};
